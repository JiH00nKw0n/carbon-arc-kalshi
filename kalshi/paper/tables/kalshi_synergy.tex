...
\midrule
$H$ & 0.791 & 0.760 & 0.893 & 6.738 \\
$H+X$ & 0.930 & 0.923 & 0.970 & 3.927 \\
$H+Z$ & 0.904 & 0.890 & 0.959 & 4.184 \\
$H+X+Z$ & 0.913 & 0.912 & 0.967 & 3.910 \\
\midrule
Corr. synergy & \multicolumn{4}{c}{-0.078 [-0.226, -0.001]} \\
MSE-skill synergy & \multicolumn{4}{c}{-0.147 [-0.394, -0.003]} \\
\bottomrule
\end{tabular}
\end{table}
